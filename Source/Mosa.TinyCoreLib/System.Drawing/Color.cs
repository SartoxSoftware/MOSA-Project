...
public readonly struct Color : IEquatable<Color>
{
	...
	public static Color FromArgb(int alpha, Color baseColor) => throw new NotImplementedException();
	
	public static Color FromArgb(int red, int green, int blue) => new(255, (byte)red, (byte)green, (byte)blue);

...
internal static class Exceptions
{
    ...
    public static class Generic
    {
        ...
        [DoesNotReturn] public static void IndexOutOfRange() => throw new IndexOutOfRangeException();
        ...
        [DoesNotReturn] public static void ThrowIncorrectTypeException(string name) => throw new ArgumentException("The parameter isn't of the correct type.", name);
        [DoesNotReturn] public static void InvalidCast() => throw new InvalidCastException();
        [DoesNotReturn] public static void Format() => throw new FormatException();
        [DoesNotReturn] public static void Overflow() => throw new OverflowException();
    }

    public static class Monitor
    {
        [DoesNotReturn] public static void ThrowLockTakenException(string name) => throw new ArgumentException("The parameter must be false.", name);
    }

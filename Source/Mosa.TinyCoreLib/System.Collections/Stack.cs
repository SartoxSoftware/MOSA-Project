...
public class Stack : ICollection, IEnumerable, ICloneable
{
	...
	public Stack(ICollection col)
	{
		...
		// The official implementation also uses Push() here, even though it's a virtual method... so I'm assuming it's
		// okay to use it??
	...
	public virtual object Clone()
	{
		...
		// Since Clone() just creates a copy of the Stack, the items must keep the same order
	...
	public virtual IEnumerator GetEnumerator() => new LinkedList<object?>.Enumerator(backingList);

...
public readonly ref struct ReadOnlySpan<T>
{
	...
	{
		// We aren't following what the spec says here, and we throw an exception if "array" is null.
	...
	public ReadOnlySpan(T[]? array, int start, int length)
	{
		...
		// TODO: Is this right? Roslyn says this statement is always false... but why?
		if (array is null)
		{
	...
	public ReadOnlySpan<T> Slice(int start)
	{
		...
		return new ReadOnlySpan<T>(ref Unsafe.Add(ref backingPointer, start), backingLength);
	}

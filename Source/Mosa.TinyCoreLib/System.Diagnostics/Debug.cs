...
public static class Debug
{
	...
	public static void Fail(string? message, string? detailMessage)
		=> Environment.FailFast((message ?? "No message") + "\nDetails: " + (detailMessage ?? "No details"));
	...
	public static void Write(object? value, string? category)
		=> Write("DEBUG (" + (category ?? "No category") + "): " + (value ?? "No value"));
	...
	public static void Write(string? message, string? category)
		=> Write("DEBUG (" + (category ?? "No category") + "): " + (message ?? "No message"));
	...
	public static void WriteLine(object? value, string? category)
		=> WriteLine("DEBUG (" + (category ?? "No category") + "): " + (value ?? "No value"));
	...
	public static void WriteLine(string? message, string? category)
		=> WriteLine("DEBUG (" + (category ?? "No category") + "): " + (message ?? "No message"));
